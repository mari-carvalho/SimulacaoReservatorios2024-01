class erros_pp_gs():
    def calculate_erros_tempo():
        ...
        def calculate_h_t_ex():
            ...
            for i in h_t:
                ...
                x_ex, t_ex, p_ex = analiticas.calculate_analitica_dirchlet(p0,pw,qw,q0,cc,mi,k,h,phi,c,L,A,x0,xf,t0,tf,i,j,n_t,n_x)
        ...
        for i in range(len(p_calc_array)): # acesso a matriz menor
            ...
            L2_list_fp_gs.append(L2)
        print('L2', L2_list_fp_gs)

        L2_log_list = np.log(L2_list_fp_gs)

        # Norma E_inf
        E_inf_depois_list_fp_gs = []
        ...
        for i in range(len(p_calc_array)): # acesso a matriz menor
            ...
            E_inf_depois_list_fp_gs.append(E_inf_depois)

        E_inf_depois_log_list = np.log(E_inf_depois_list_fp_gs)

        # Norma E_rel
        err_rel_total_list_pp_gs_fp_gs = []
        ...
        for i in range(len(p_calc_array)): # acesso a matriz menor
            ...
            err_rel_total_list_pp_gs_fp_gs.append(err_rel_total)

        err_rel_total_log_list = np.log(err_rel_total_list_pp_gs_fp_gs)

        h_t_log_list = np.log(h_t)

        # Plotagem:
        plt.plot(h_t_log_list, L2_list_fp_gs, linestyle='none', marker='o', color="#FF007F", label='Erro Analítica/Explícita')
        ...
        # Plotagem:
        plt.plot(h_t_log_list, E_inf_depois_list_fp_gs, linestyle='none', marker='o', color="#FF007F", label='Erro Analítica/Explícita')
        ...
        # Plotagem:
        plt.plot(h_t_log_list, err_rel_total_list_pp_gs_fp_gs, linestyle='none', marker='o', color="#FF007F", label='Erro Analítica/Explícita')
        ...
        for n_t_val, L2_val, E_inf_val, err_rel_val in zip(n_t_array, L2_list_fp_gs, E_inf_depois_list_fp_gs, err_rel_total_list_pp_gs_fp_gs):
    ...
    def calculate_erros_malha():
        ...
        # Plotagem:
        plt.plot(h_x_log_list, L2_list_fp_gs, linestyle='none', marker='o', color="#FF007F",
        ...
        # Plotagem:
        plt.plot(h_x_log_list, E_inf_depois_list_fp_gs, linestyle='none', marker='o', color="#FF007F",
                 label='Erro Analítica/Explícita')
        plt.title('Erro Absoluto Máximo - Norma E$ \infty$')
        plt.legend()
        plt.xlabel(r'$\bigtriangleup x$ [s]')
        ...
        # Plotagem:
        plt.plot(h_x_log_list, err_rel_total_list_pp_gs_fp_gs, linestyle='none', marker='o', color="#FF007F",label='Erro Analítica/Explícita')
        plt.title('Erro Relativo - Norma L1')
        plt.legend()
        plt.xlabel(r'$\bigtriangleup x$ [s]')
        plt.ylabel('L1')
        ...
        for n_x_val, L2_val, E_inf_val, err_rel_val in zip(n_x_array, L2_list_fp_gs, E_inf_depois_list_fp_gs, err_rel_total_list_pp_gs_fp_gs):
            rounded_L2_val = round(L2_val, 3)
            rounded_E_inf_val = round(E_inf_val, 3)
            rounded_err_rel_val = round(err_rel_val, 3)
